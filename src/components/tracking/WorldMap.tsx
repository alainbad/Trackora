  ...
  return (
    ...
    >
      ...
      {points?.map((p, i) => {
        ...
        // Waypoint gets no label — legend already shows "Current"
        const showLabel = p.type !== 'waypoint' && !!p.label
        // Origin label below dot, destination label above dot
        const labelOffsetY = p.type === 'origin' ? 26 : -18
